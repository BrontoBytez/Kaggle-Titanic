...
get.formula.list <- function(){
    formula.list = c(Survived~Age+Sex+Pclass+Title+Embarked,
                     Survived~Age+Sex+Pclass+Title+Embarked+Fare,
                     Survived~Age+Sex+Pclass+Title+Embarked+Fare+IsChild,
                     Survived~Age+Sex+Pclass+Title+Embarked+Fare+IsChild+FamilySize
                     );
    return (formula.list);
}
